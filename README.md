...
|--------|------|---------|-------------|
| **greycat** | Skill | 1.8.4 | Full-stack GreyCat development — GCL language, graph persistence, React integration |
| **greycat-c** | Skill | 1.8.4 | GreyCat C API and Standard Library for native development |
| **greycat-lsp** | LSP | 1.8.4 | Language Server Protocol for `.gcl` files (completion, diagnostics, hover) |
| **llamacpp** | Skill | 1.8.4 | llama.cpp C API reference (163 functions) for local LLM inference |
