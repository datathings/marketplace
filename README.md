...
|--------|------|---------|-------------|
| **greycat** | Skill | 1.7.9 | Full-stack GreyCat development — GCL language, graph persistence, React integration |
| **greycat-c** | Skill | 1.7.9 | GreyCat C API and Standard Library for native development |
| **greycat-lsp** | LSP | 1.7.9 | Language Server Protocol for `.gcl` files (completion, diagnostics, hover) |
| **llamacpp** | Skill | 1.7.9 | llama.cpp C API reference (163 functions) for local LLM inference |
