...
**Previously (b10665, 249 commits since b10416)** — no functions added, removed, or re-signatured. The public C API changed only in struct fields, one new enum, and the state-file versions:
